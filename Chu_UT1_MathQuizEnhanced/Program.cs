...
{
    /* Method: Main
     * Purpose: Enhances the original code where the program accepts decimals and adds division questions
     * Restrictions: None
     */
    static void Main()
    {
    ...
    start:
        ...
        for (nCntr = 0; nCntr < nQuestions; ++nCntr)
        {
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Please enter a number that at most has 2 decimal places.");
                    bValid = false;
                }
