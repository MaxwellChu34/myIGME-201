...
namespace PeopleApp
{
    /* Class: PeopleApp
     * Author: Maxwell Chu
     * Purpose: Organizes school information
     * Restrictions: None
     */
    class PeopleApp
    {
        /* Method: Main
         * Purpose: Displays people's school information
         * Restrictions: None
         */
                ...
                switch (sAction)
                {
                    ...
                    case "list":
                        ...
                        foreach (KeyValuePair<string, Person> thisEntry in people.sortedList)
                        {
                            ...
                            ++i;
                            foreach (KeyValuePair<string,Course> courses in courses.sortedList)
                            {
                                Console.WriteLine($"{courses.courseCode} - {courses.courseDescription} {schedule.daysOfWeek} {courses.schedule.startTime:hh:mmtt} - {courses.schedule.endTime:hh:mmtt}");
                            }
                        }
        ...
        /* Method: EditPerson
         * Purpose: Handles information about editing what a person's already made
         * Restrictions: None
         */
        public static void EditPerson(ref Person thisPerson)
        {
            ...
            if (sCourse.Length == 0)
            {
                thisPerson.courseCode = sCourse;
            }
        }
        /* Method: LiveADay
         * Purpose: Handles stuff like eating and partying
         * Restrictions: None
         */
